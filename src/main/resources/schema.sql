...
INSERT INTO posts (title, image_url, content, like_count) VALUES
                                                              ('Первый пост', '/images/1.png', 'Это содержимое первого поста.', 1),
                                                              ('Второй пост', '/images/2.png', 'Это содержимое второго поста.', 1),
                                                              ('Третий пост', '/images/3.png', 'Это содержимое третьего поста.', 1);
